...
{
    public partial class DegreePlanMSACS2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DegreePlanAbrev = table.Column<string>(nullable: true),
                    DegreePlanName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DegreePlanTermRequirement_StudentTerm_TermID",
                        column: x => x.TermID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DegreePlanTermRequirement_TermID",
                table: "DegreePlanTermRequirement",
                column: "TermID");
